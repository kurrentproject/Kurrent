...
static const int64 DUST_SOFT_LIMIT = 1000; // 0.00001 KURT
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 100;   // 0.000001 KURT mininput
/** No amount larger than this (in ztoshi) is valid */
static const int64 MAX_MONEY = 228000000 * COIN;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 50;
static const int ZCOIN_BUG_FIX_SWITCH_BLOCK = 92000;
