    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Kurrent") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Kurrent address"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Kurrent"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Kurrent addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Kurrent addresses"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Kurrent client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kurrent network", "", count));
}
...
{
    QString strTitle = tr("Kurrent"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Kurrent address or malformed URI parameters."),
